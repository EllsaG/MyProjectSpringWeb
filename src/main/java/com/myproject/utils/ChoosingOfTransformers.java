...
public class ChoosingOfTransformers {
    ...
    public TransformerSelection ratedPowerForChoosingOfTransformer(long id, double maxFullPower) {
    ...
    public PowerTransformers createNewTransformer(long id, String modelOfTransformer, double fullPowerOfTransformer,
        ...
        TransformerSelection transformerSelection = forChooseTransformersRepository.findById(id).get();
